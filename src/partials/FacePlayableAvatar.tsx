            ...
            >
              ...
              >
                ...
                <mask id="react-mask-96" fill="white">
                  <use xlinkHref="#react-path-95"></use>
                </mask>
                <use
                  id="Clothes"
                  fill="#E6E6E6"
                  fillRule="evenodd"
                  xlinkHref="#react-path-95"
                ></use>
                <g
                  id="Color/Palette/Gray-01"
                  mask="url(#react-mask-96)"
                  fillRule="evenodd"
                  fill="#262E33"
                >
              ...
              <g id="Top" strokeWidth="1" fillRule="evenodd">
                ...
                <mask id="react-mask-116" fill="white">
                  <use xlinkHref="#react-path-118"></use>
                </mask>
                <g id="Mask"></g>
                <g id="Top/Short-Hair/The-Caesar" mask="url(#react-mask-116)">
                  <g transform="translate(-1.000000, 0.000000)">
                    ...
                    >
                      <mask id="react-mask-117" fill="white">
                        <use xlinkHref="#react-path-119"></use>
                      </mask>
                      <use
                        id="Caesar"
                        fill="#28354B"
                        xlinkHref="#react-path-119"
                      ></use>
                      <g
                        id="Skin/👶🏽-03-Brown"
                        mask="url(#react-mask-117)"
                        fill="#B58143"
                      >
                        <g
